            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-3">
                        <Link to="/contact" class="btn btn-black f-right">Contact Me Now</Link>
                    </div>
                </div>
            </div>
        </section>
       
        <div class="contact-info-area w-padding2 bg-info mt-5" data-background="assets/img/gallery/section_bg04.jpg">
            <div class="container">
