...
//#region node_modules/bootstrap/dist/js/bootstrap.bundle.js
var require_bootstrap_bundle = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	...
	*/
	(function(global, factory) {
		...
		*/
		class Dropdown extends BaseComponent {
			...
			_getConfig(config) {
				...
				if (typeof config.reference === "object" && !isElement$1(config.reference) && typeof config.reference.getBoundingClientRect !== "function") throw new TypeError(`${NAME$a.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
				return config;
			}
			_createPopper() {
				if (typeof Popper === "undefined") throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org/docs/v2/)");
		...
		*/
		...
		const EVENT_KEY$5 = `.bs.focustrap`;
		...
		*/
		...
		const EVENT_KEY$3 = `.bs.offcanvas`;
